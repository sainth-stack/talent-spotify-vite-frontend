...
const PerformanceManagement = () => {
  ...
  const opt1=[{ key: "Behaviour", value: "Behaviour" },{ key: "OKR", value: "OKR" }]
  const opt2=[{ key: "Monthly", value: "Monthly" },{ key: "Quarterly", value: "Quarterly" },{ key: "Semi Annually", value: "Semi Annually" },{ key: "Annually", value: "Annually" }]
      ...
      <div className="bg-light-primary rounded-12 mh-100 p-4 m-4">
        ...
        <div className="company-form1">
          <div className="container">
            <div className="row ">
              <div className="col-5  p-0">
                ...
                <SelectInput options={opt1} label="Type of evaluation" value={evaluationType} onChangeText={(e) => setEvaluationType(e.target.value)} style={{width:"20px",paddingLeft:0}}/>
              </div>
              <div className="col-6 pl-5 ">
              <SelectInput options={opt2} label="Frequency of evaluation" value={evaluationFrequency} onChangeText={(e) => setEvaluationFrequency(e.target.value)}              />
          ...
          <div className="container">
            ...
            <div className="col-5 ">
              <div className="mt-2">
                              <TextInput label={<span style={{"padding":"0px","margin":"0px"}} >OKR Weightage</span>}  className=" form-control"/>
                             
             </div>
             <div className="mt-3">
              <TextInput label="Comepetency Weightage" className=" form-control"/>
              </div>
              <div className="mt-2">
