...
const LeaveTable1 = () => {
  ...
  const columns = [
    {
      id: "okrName",
      label: renderHeaderWithSort("objective", "objective"),
      render: (row) => row.okrName,
    },
    {
      id: "keyResultName",
      label: renderHeaderWithSort("KR", "KR"),
      render: (row) => row.keyResultName,
    },
    {
      id: "frequency",
      label: renderHeaderWithSort("frequency", "frequency"),
      render: (row) => row.frequency,
    },
    {
      id: "UOM",
      label: renderHeaderWithSort("UOM", "UOM"),
      render: (row) => row.UOM,
    },
    {
      id: "polarity",
      label: renderHeaderWithSort("polarity", "polarity"),
      render: (row) => row.polarity,
    },
    {
      id: "targetDate",
    ...
    {
      id: "target",
      label: renderHeaderWithSort("target", "target"),
      render: (row) => row.target,
    },
    {
      id: "actual",
      label: renderHeaderWithSort("actual", "actual"),
