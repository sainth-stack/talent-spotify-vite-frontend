    ...
    if (displayOptions2.offTrack && !displayOptions2.onTrack && !displayOptions2.atRisk) {
      if (item.progressStatus >= 0 && item.progressStatus <= 60) {
        return (
          ...
          item.title.toLowerCase().indexOf(searchKey.toLowerCase()) !==
          -1 ||
          item.status.toLowerCase().indexOf(searchKey.toLowerCase()) !==
          -1 ||
          item.priority.toString().toLowerCase().indexOf(searchKey.toLowerCase()) !==
          -1 ||
          item.mainTask.toLowerCase().indexOf(searchKey.toLowerCase()) !==
          -1 ||
          item.targetDate.toString().toLowerCase().indexOf(searchKey.toLowerCase()) !==
          -1 ||
