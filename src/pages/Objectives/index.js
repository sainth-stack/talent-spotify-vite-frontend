...
export default function Objectives() {
        ...
        let updatedData = data
          .filter((item) => {
            if (selectedTab !== null && selectedTab.tab === "me") {
              ...
              selectedTab !== null &&
              selectedTab.tab === "myteam" &&
              (AuthRole === "HR Admin" || AuthRole === "Super Admin")
            ) {
  ...
  return (
    <>
      ...
      <TitleHeader name={t("objectives.Title")} /> {/* vishnu */}
      <div
      ...
      >
        ...
        >
          {!isMobile && (
            <p className={`title text-dark font-weight-bold`}>
              {t("objectives.Hello")} {AuthUser.firstName}!,
              {t("objectives.User_Objecttives")} {trackingStatus}{" "}
              {t("objectives.To_be_complete")}
            </p>
          )}
        </div>
        <div className={isMobile ? "" : "company-form"}>
          <div className="container">
            <div
              className={isMobile ? "company-form-mobile" : "row"}
              id="okrSummary"
            >
              {isMobile && (
                <div className="d-flex justify-content-between">
                  ...
                  >
                    Hello {AuthUser.name}!, Your objectives are {trackingStatus}{" "}
              ...
              <div className={`${isMobile ? "m-0 p-0" : "col-lg"}`}>
                <SelectInput
                  label={t("objectives.Employee_Name")}
                  placeholder="--Select--"
                  name="employeeName"
                  options={empData}
