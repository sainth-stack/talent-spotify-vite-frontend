          ...
          data.length > 0 ? (
            isMobile ? <ObjectiveMobileTable
              ...
              childData={{
                ...
                columnsChildTasks: columnsChild,
                searchKey,
                checkboxOptions,
              }}
            />) : <div className="text-center">
