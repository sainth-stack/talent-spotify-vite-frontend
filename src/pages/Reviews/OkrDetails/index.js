...
export default function OkrDetails(props) {
  ...
  const emptyData = {
    ...
    actual: okrdetails.actual ? okrdetails.actual : 0,
    ...
    if (validator.current.allValid()) {
      try {
        if (update) {
          ...
          const finalData = { ...updateData, ...finalCheckBox };
    ...
    <div style={{ height: "100vh", overflow: "auto" }}>
      ...
      >
                    ...
                    <Row className={isMobile ? "p-2" : "mt-3"}>
                      ...
                      <Col lg={isMobile ? "10" : "6"} className="">
                        <TextInput
                          ...
                          onChangeText={handleChangeSearch}
                          //disabled={!(updateData.objectiveStatus === "Unlock" || updateData.objectiveStatus === "Reject" || updateData.objectiveStatus === "Create" || updateData.objectiveStatus === "Update" || updateData.objectiveStatus === "Approve") && privileges && privileges.length > 0 && (privileges.filter(privilege => privilege.page === "Key Results").length > 0 && privileges.filter(privilege => privilege.page === "Key Results")[0].edit || privileges.filter(privilege => privilege.page === "Key Results - Actual, comments update once locked").length > 0 && privileges.filter(privilege => privilege.page === "Key Results - Actual, comments update once locked")[0].edit)}
                        />
                      </Col>
                    </Row>
                    ...
                    <div className={isMobile ? "d-none" : "row mt-3"}>
                      ...
                      {Object.keys(updateData).length > 0 && (
                        <Button
                          ...
                          className={`bg-${
                            updateData.target === updateData.actual ||
                            !(
        ...
        {isMobile && (
          <div
            className={`${
              !krForm ? "d-flex justify-content-center okr-footer" : "d-none"
            }`}
          >
            <Button
