...
export default function UploadProgress({ filename: title = "", status = "inprogress", fileSize: size = "0kb", progressWidth = 0, cancelUpload, loadedData: loaded = 0, totalData: total = 0, deleteUpload, _id: id, fileUrl: link = "", index }) {
  return (
